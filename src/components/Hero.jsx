  ...
  return (
    <>
      ...
      >
        ...
        <div
          className="absolute top-[40%] right-[5%] w-96 h-96 bg-blue-600/40 rounded-full filter blur-[120px] opacity-70 animate-blob z-0 pointer-events-none"
          style={{ animationDelay: "2s" }}
        ></div>
        <div
          className="absolute bottom-[10%] left-[35%] w-80 h-80 bg-purple-600/40 rounded-full filter blur-[100px] opacity-60 animate-blob z-0 pointer-events-none"
        ...
        <div className="w-full px-6 md:px-12 xl:px-20 2xl:px-32 max-w-[2400px] mx-auto z-10 relative">
          <div className="flex flex-col lg:flex-row items-center justify-between gap-12 min-h-[80vh]">
              ...
              >
                ...
                <div className="flex items-center gap-4 relative z-50 pointer-events-auto">
                  <a
                    ...
                    className="w-12 h-12 rounded-full glass flex items-center justify-center text-gray-300 hover:text-white hover:bg-white/10 transition-all font-medium"
                  >
                    <FaGithub size={20} />
                  </a>
                  <a
            ...
            <div className="lg:w-1/2 xl:w-[45%] hidden -mt-20 lg:flex flex-col items-center justify-center gap-6 relative">
              ...
              <FloatingCard
                delay={0.4}
                className="w-full max-w-md font-mono text-sm relative overflow-hidden"
              >
                {/* Terminal Dots */}
